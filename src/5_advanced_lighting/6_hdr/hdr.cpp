...
int main()
{
    ...
    // -------------------------
    Shader shader("6_lighting.vert", "6_lighting.frag");
    Shader hdrShader("6_hdr.vert", "6_hdr.frag");
    ...
    // GL_RGBA16F -> no automatic gamma correction in fs output
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // and tonemap HDR colors to default framebuffer's color
        // -----------------------------------------------------
        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
        hdrShader.use();
        glActiveTexture(GL_TEXTURE0);
