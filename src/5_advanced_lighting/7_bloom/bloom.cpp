...
int main()
{
    ...
    // -------------------------
    Shader shader("7_bloom.vert", "7_bloom.frag");
    Shader shaderLight("7_bloom.vert", "7_light_box.frag");
    Shader shaderBlur("7_blur.vert", "7_blur.frag");
    Shader shaderBloomFinal("7_bloom_final.vert", "7_bloom_final.frag");
    ...
    unsigned int containerTexture = loadTexture(FileSystem::getPath("resources/textures/wood.png").c_str(), true);
    ...
    // create 2 float point color buffers (1 for normal rendering, other for brightness)
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render one large cube that acts as the floor
        model = glm::mat4(1.0f);
