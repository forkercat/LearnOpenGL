...
int main()
{
    ...
    // -------------------------
    Shader shader(
        "3_1_2_shadow_mapping.vert", "3_1_2_shadow_mapping.frag");
    Shader simpleDepthShader(
        "3_1_2_shadow_mapping_depth.vert", "3_1_2_shadow_mapping_depth.frag");
    Shader debugDepthQuad(
        "3_1_2_debug_quad.vert", "3_1_2_debug_quad_depth.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // reset viewport
        glViewport(0, 0, SCR_WIDTH * 2, SCR_HEIGHT * 2);  // for mac retina
        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
