      ...
      Confuse(false), Chaos(false), Shake(false)
{
    ...
    glRenderbufferStorageMultisample(GL_RENDERBUFFER, 4, GL_RGB, width, height);  // allocates storage for render buffer object
    ...
    // initialize the FBO/texture to blit multisampled color-buffer to
...
void PostProcessor::EndRender()
{
    ...
    glBindFramebuffer(GL_FRAMEBUFFER, 0);  // binds both READ/WRITE framebuffer to default
}
